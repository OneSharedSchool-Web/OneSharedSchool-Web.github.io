$(document).ready(function () {
    ...
    ref.once("value", (data) => {
        ...
        for (var i = 0; i < keys.length; i++) {
            ...
            //reject_div
            //check_div
            $("#reject_div").each(function (index, object) {
                object.click(function () {
                    var user_uid = object.parent().attr('id')
                    console.log("reject button clicked", user_uid)
                })
            });
            $("#check_div").each(function (index, object) {
                object.click(function () {
                    var user_uid = object.parent().attr('id')
                    console.log("accept button clicked", user_uid)
                })
            });
